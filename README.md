...
```sh
npm install git+ssh://git@github.com:SolomonAIEngineering/workspace-financial-backend-sdk.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/SolomonAIEngineering/workspace-financial-backend-sdk/issues) with questions, bugs, or suggestions.
