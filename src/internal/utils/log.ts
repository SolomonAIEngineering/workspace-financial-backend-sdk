...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: WorkspaceFinancialBackendSDK): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: WorkspaceFinancialBackendSDK): Logger {
